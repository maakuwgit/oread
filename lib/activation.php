        ...
        <tr valign="top"><th scope="row"><?php _e('Create navigation menus?', 'roots'); ?></th>
          <td>
            <fieldset>
              ...
              <p class="description"><?php printf(__('Create the Primary, Secondary and Footer Navigation menus and set the locations', 'roots')); ?></p>
            </fieldset>
          </td>
        </tr>
...
function roots_theme_activation_action() {
  ...
  if ($roots_theme_activation_options['create_navigation_menus'] === 'true') {
    ...
    if (!$secondary_nav) {
      $secondary_nav_id = wp_create_nav_menu(__('Secondary Navigation', 'roots'), array('slug' => 'secondarynavigation'));
